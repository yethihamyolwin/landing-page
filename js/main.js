...
var waypoint = new Waypoint({
  ...
  handler: function (direction) {
    navControl.classList.add("fixed", "w-full");
  },
  offset: "75%",
});
...
var waypoint = new Waypoint({
  ...
  handler: function (direction) {
    if (direction === "down") {
      navControl.classList.add("fixed", "w-full", "animate__fadeInDown");
    } else {
      navControl.classList.remove("fixed", "w-full", "animate__fadeInDown");
    }
  },
  offset: "75%",
});
